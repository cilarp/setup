...
#vim set up
echo "set up vim"
apt install -y ncurses-dev lua5.2 lua5.2-dev luajit python-dev python3-dev ruby-dev
cd /opt/
...
#neovim setup
echo "set up neovim"
apt install -y python3-pip m4 cmake automake unzip gettext
pip3 install pynvim
cd /opt/
